  ...
  return (
    <div className="bg-gradient-to-br from-[#f6f6f4] via-white to-[#ececec] text-[#111]">
      ...
      <motion.div
        ...
        animate="visible"
      >
        <div className="relative isolate flex min-h-[100svh] flex-col gap-2 sm:gap-3 lg:min-h-[78vh] lg:grid lg:grid-cols-[260px_minmax(0,1fr)_260px] lg:gap-8 xl:grid-cols-[280px_minmax(0,1fr)_280px]">
          <motion.section
