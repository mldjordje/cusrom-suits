...
// Strength of multiply shading images (depth)
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Per-layer shading on top for depth */}
        {torsoLayers.map((layer) => (
          <div key={layer.id} className="absolute inset-0">
            <Image
              ...
              sizes="(max-width: 768px) 100vw, 520px"
              priority
              style={{ objectFit: "contain", pointerEvents: "none", mixBlendMode: "multiply", opacity: shadeOpacity, filter: "contrast(1.06)" }}
            />
          </div>
        ))}
        ...
        {pocketSrc && (
          <div className="absolute inset-0 z-10">
            ...
            <Image src={replaceColorInSrc(pocketSrc)} alt="pockets" fill sizes="(max-width: 768px) 100vw, 520px" priority style={{ objectFit: "contain", pointerEvents: "none", mixBlendMode: "multiply", opacity: shadeOpacity, filter: "contrast(1.06)" }} />
          </div>
        )}
        ...
        {breastPocketLayers && breastPocketLayers.map((layer) => (
          <div key={layer.id} className="absolute inset-0 z-20">
            ...
            <Image src={replaceColorInSrc(layer.src)} alt={layer.name} fill sizes="(max-width: 768px) 100vw, 520px" priority style={{ objectFit: "contain", pointerEvents: "none", mixBlendMode: "multiply", opacity: shadeOpacity, filter: "contrast(1.06)" }} />
          </div>
        ))}

        {/* Lapel shading (fabric already in union) */}
        {lapelSrc && (
          <div className="absolute inset-0 z-0">
            <Image src={replaceColorInSrc(lapelSrc)} alt="lapel" fill sizes="(max-width: 768px) 100vw, 520px" priority style={{ objectFit: "contain", pointerEvents: "none", mixBlendMode: "multiply", opacity: shadeOpacity, filter: "contrast(1.06)" }} />
          </div>
        )}
      </div>
      ...
      {pantsLayer && (
        ...
        >
          <div className="absolute inset-0">
            ...
            <Image src={replaceColorInSrc(pantsLayer.src)} alt="pants" fill sizes="(max-width: 768px) 100vw, 760px" priority style={{ objectFit: "contain", pointerEvents: "none", mixBlendMode: "multiply", opacity: shadeOpacity, filter: "contrast(1.06)" }} />
          </div>

          {cuffSrc && (
            <div className="absolute inset-0">
              <div className="absolute inset-0" style={fabricStyle(cuffSrc)} />
              <Image src={replaceColorInSrc(cuffSrc)} alt="cuffs" fill sizes="(max-width: 768px) 100vw, 760px" priority style={{ objectFit: "contain", pointerEvents: "none", mixBlendMode: "multiply", opacity: shadeOpacity, filter: "contrast(1.06)" }} />
            </div>
          )}
          ...
          {pantsPleatSrc && (
            <div className="absolute inset-0">
              ...
              <Image src={replaceColorInSrc(pantsPleatSrc)} alt="pants-pleats" fill sizes="(max-width: 768px) 100vw, 760px" priority style={{ objectFit: "contain", pointerEvents: "none", mixBlendMode: "multiply", opacity: shadeOpacity, filter: "contrast(1.06)" }} />
            </div>
          )}
        </div>
      )}
