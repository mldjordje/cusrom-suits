...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "`Lager magacin 1` i `Ukupan lager` su kolicine. Admin ove vrednosti unosi rucno pri kreiranju proizvoda ili kroz izmenu reda u tabu proizvodi.",
      "Kada kupac zavrsi kupovinu na webshop checkout-u, sistem automatski umanjuje lager za kupljenu kolicinu.",
      "Za porudzbine sa Ananasa, lager se osvezava kroz integracioni tok (inbound sync) koji povlaci stanje iz glavnog izvora, pa update ulazi nazad u katalog.",
  ...
  },
  {
    ...
    body: [
      ...
      "Na Ananas idu samo proizvodi koji su aktivni i imaju ukljucen `Export`; to je glavni filter za slanje kroz sync.",
      "`Sinhronizator` radi kao orkestrator u tri domena: inbound lager ulaz, Ananas sync i outbound dokumenti/izvozi. Svaki run se vidi u Integracije tabu.",
      "Ako treba da osvezis stanje ili cene, prvo uradi korekciju u proizvodu/lageru, pa pokreni odgovarajuci sync run i proveri rezultat + retry ako treba.",
  ...
  {
    title: "8. Kako admin dodaje novi proizvod",
    body: [
      "Idi na `Web Shop -> Proizvodi i lager` i u formi `Dodaj novi proizvod` unesi SKU, naziv, kategoriju, cenu i lager.",
      "Posle cuvanja, proizvod se pojavljuje u listi i mozes odmah menjati cenu, stanje, aktivan/export statuse i landing parametre.",
      "Ako proizvod treba da bude prikazan na pocetnoj, dodatno ga ubaci u odgovarajucu sekciju kroz tab `Pocetna i sekcije`.",
      "Ako proizvod treba da ide na Ananas, proveri da je `Export` ukljucen i da ima validne osnovne podatke (SKU, naziv, cena, lager).",
    ],
  },
];
