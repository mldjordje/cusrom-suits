...
export default function AdminLandingProductPickGrid({
  ...
  return (
    <div className="mt-2 max-h-64 overflow-y-auto rounded-xl border border-slate-100 bg-slate-50/90 p-2">
      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-4">
        {slice.map((item) => (
          <button
            ...
            className="group flex flex-col overflow-hidden rounded-lg border border-slate-200 bg-white text-left shadow-sm transition hover:border-blue-400 hover:shadow-md"
          >
            <div className="relative h-24 w-full shrink-0 bg-slate-100">
              <Image
                src={coverSrc(item)}
                alt=""
                fill
